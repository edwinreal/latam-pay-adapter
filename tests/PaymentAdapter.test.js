...
describe('PaymentAdapter & Factory', () => {
    ...
    test('PayUAdapter should translate amount to cents', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('[PayU]'), expect.stringContaining('"amount":10050'));
    ...
    test('MercadoPagoAdapter should maintain decimal amount', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('[MercadoPago]'), expect.stringContaining('"transaction_amount":100.5'));
        consoleSpy.mockRestore();
    });
});
//# sourceMappingURL=PaymentAdapter.test.js.map